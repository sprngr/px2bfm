...
const bfmJSON = require('./bitfontmaker2.json');
let outputJSON;
...
module.exports = function (imagePath, name, creator) {
    // Reset outputJSON on every run with deep copy
    // This is specifically for the browser
    outputJSON = JSON.parse(JSON.stringify(bfmJSON));
